...
class ContextCompressor {
    ...
    // 压缩上下文
    static async compressContext(uncompressedStory, apiKey, aiProvider = 'deepseek', aiModel = null, customSettings = null) {
...
6. 长度控制在300字以内`;
        ...
        try {
            ...
            // 提取响应内容，根据不同服务商的格式
            const compressedSummary = ProviderConfig.processApiResponse(aiProvider, responseData);
